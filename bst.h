...
int bst_init(bst_t *b, size_t elem_sz, int (*cmp)(const void *, const void *),
             void (*free_ele)(void *));
...
static bst_node *__rec_insert(bst_node *n, const void *elem, size_t elem_sz,
                              int (*cmp)(const void *, const void *)) {
    if (!n)
...
static int __rec_contains(const bst_node *n, const void *elem,
                          int (*cmp)(const void *, const void *)) {
    if (!n)
        return 0;
    int k = cmp(elem, n->val);
